...
- [ ] T048 [P] Add request ID, user-safe error, and secret-redaction logging coverage in `tests/integration/test_observability.py`
- [ ] T049 [P] Add the complete profile-to-CV acceptance scenario in `tests/integration/test_end_to_end_platform.py`
- [ ] T050 [P] Add migration-upgrade and schema-constraint coverage in `tests/integration/test_migrations.py`
- [ ] T051 Document local configuration, permitted file types, environment variables, and focused test commands in `README.md` and `.env.example`
